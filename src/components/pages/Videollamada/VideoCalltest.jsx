...
const mainSubscribersResolution = { width: MetricsSizesW.maxLargeW * 25.6, height: 720 };
const secondarySubscribersResolution = { width: MetricsSizesW.maxLargeW * 7.04, height: 288 };

function VideoCall() {
    const location = useLocation();

    var apiKey = "46527582";
    var sessionId = location;
    console.log("VideoCall Init sessionID: ",this.sessionId);
   ...
   function init( ) {
        ...
        this.employeeId = this.props.route.params.employee;
        this.resolution = this.props.route.params.resolution;
        this.state = {
            loadingVideo : true,
            // subscribers: 0,
        ...
        this.publisherProperties = {
            ...
            fitMode: 'contain',
            insertMode: 'append',
            resolution: this.props.route.params.resolution
        };
    }
    ...
    videoView = () => {
        return (
            <>
                <View>
                    {
                        (this.type != 'consultancy') ?
                            <RedirectComponent navigation={this.props.navigation} resolution={this.resolution} /> : null
                ...
                <View style={styles.fullView}>
                    <OTSession
                        ...
                        <View style={styles.publisherStyle}>
                            ...
                            />
                            <View style={styles.borderPublisher}></View>
                        </View>
                ...
                <ImageBackground source={Images.callBottom} style={[styles.buttonView, Layout.row]}>
    ...
    render() {
        return this.joinCall ? this.videoView() : null;
    }
}
...
const styles = StyleSheet.create({
    ...
    iconStyle: {
        fontSize: FontSize.regular * 2.125,
    ...
    finishBtn: {
        fontSize: FontSize.regular * 3.125,
        marginRight: '5%',
        marginLeft: '5%',
        width: MetricsSizesW.maxLargeW * 1.5,
        height: MetricsSizesW.maxLargeW * 1.5,
        alignItems: 'center',
        justifyContent: 'center',
        borderRadius: 50,
    ...
    loading: {
        marginTop: dimensions.height * 0.57
    },
    borderPublisher: {
        borderWidth: dimensions.width * 0.02,
        borderStyle: 'solid',
        borderRadius: 20,
        borderColor: '#000000',
        marginTop: -dimensions.height * 0.21,
